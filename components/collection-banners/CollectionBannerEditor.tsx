...
export default function CollectionBannerEditor({
  ...
  async function handleRemove() {
    ...
    if (
      !window.confirm(
        `Remove Collection Banner ${slot}? This cannot be undone.`
      )
    ) {
      return;
    }
    ...
    >
      ...
      >
        <div>
          ...
          >
            Display slot {slot} on the Collections page carousel.
          </p>
        </div>
      ...
      {imageUrl && (
        <div style={{ marginBottom: 20 }}>
          <img
            src={imageUrl}
            alt={altText || `Collection Banner ${slot}`}
            style={{
              width: "100%",
              aspectRatio: "3.6 / 1",
              objectFit: "cover",
      ...
      >
        ...
        >
          Keep important text and products near the center because
          the banner crops differently on mobile.
        </span>
      </div>
      ...
      <div style={{ marginBottom: 18 }}>
        ...
        <input
          ...
          placeholder={`Collection Banner ${slot}`}
          style={{
            width: "100%",
            padding: "10px 12px",
